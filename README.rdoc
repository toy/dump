...
<tt>SKIP_TABLES</tt> - comma separated list of tables to ignore when restoring contents. The tables specified will still be created, they will just be empty. Table names can be prefixed with '-', which will be ignored.
