...
==== While restoring or listing dumps:
...
skip dumps with tags mirror and archive:
  rake dump TAGS='-mirror,-archive'

select dumps with tags photos or videos, with tag important and without mirror:
  rake dump TAGS='photos,videos,+important,-mirror'

==== For cleanup:

LIKE, VER, VERSION and TAG or TAGS — as for listing
